    ...
    <>
      <div className="packages-item">
                        <div className="packages-img">
                            <Image src={url} className="img-fluid w-100 rounded-top" alt="Image" width={100} height={50} sizes='150vw'/>
                            <div className="packages-info d-flex border border-start-0 border-end-0 position-absolute" style={{width: "100%", bottom: "0", left: "0", zIndex: "5" }}>
                                <small className="flex-fill text-center border-end py-2"><i className="fa fa-map-marker-alt me-2"></i> {location} </small>
                                <small className="flex-fill text-center border-end py-2"><i className="fa fa-calendar-alt me-2"></i>{dur}</small>
                                <small className="flex-fill text-center py-2"><i className="fa fa-user me-2"></i> {person}</small>
                            </div>
