                        ...
                        <div id="tab-1" className="tab-pane fade show p-0 active">
                            <div className="row g-4">
                                <div className="col-lg-4">
                                            ...
                                            <Image className="img-fluid rounded w-100" src="/images/destination-1.jpg" alt="" width={400} height={150}/>
                                        ...
                                        <div className="col-lg-4">
                                            <div className="destination-img">
                                                <Image className="img-fluid rounded w-100" src="/images/destination-2.jpg" alt="" width={400} height={150}/>
                                                <div className="destination-overlay p-4">
                                                    <a href="#" className="btn btn-primary text-white rounded-pill border py-2 px-3">20 Photos</a>
                                        ...
                                        <div className="col-lg-4">
                                            <div className="destination-img">
                                            <Image className="img-fluid rounded w-100" src="/images/destination-7.jpg" alt="" width={400} height={150}/>
                                        ...
                                        <div className="col-lg-4">
                                            <div className="destination-img">
                                                <Image className="img-fluid rounded w-100" src="/images/destination-8.jpg" alt="" width={400} height={150}/>
                                                <div className="destination-overlay p-4">
                                                    <a href="#" className="btn btn-primary text-white rounded-pill border py-2 px-3">20 Photos</a>
                                                    <h4 className="text-white mb-2 mt-3">Los angelas</h4>
                                                    <a href="#" className="btn-hover text-white">View All Place <i className="fa fa-arrow-right ms-2"></i></a>
                                ...
                                <div className="col-lg-4">
                                    <div className="destination-img">
                                    <Image className="img-fluid rounded w-100" src="/images/destination-4.jpg" alt="" width={400} height={150}/>
                                ...
                                <div className="col-lg-4">
                                    <div className="destination-img">
                                    <Image className="img-fluid rounded w-100" src="/images/destination-5.jpg" alt="" width={400} height={150}/>
                                ...
                                <div className="col-lg-4">
                                    <div className="destination-img">
                                    <Image className="img-fluid rounded w-100" src="/images/destination-6.jpg" alt="" width={400} height={150}/>
